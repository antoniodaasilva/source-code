...
import (
	...
	"github.com/antoniodaasilva/source-code/internal/infra/database"
	"github.com/antoniodaasilva/source-code/internal/usecase"
	"github.com/antoniodaasilva/source-code/pkg/kafka"
	"github.com/antoniodaasilva/source-code/pkg/rabbitmq"
...
func kafkaWorker(msgChan chan *ckafka.Message, uc usecase.CalculateFinalPrice) {
	...
	for msg := range msgChan {
		//ler a mensagem do kafka e gravar no usecase
